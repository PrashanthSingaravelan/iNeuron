...
def index():
    if request.method == 'POST':
        ...
        try:
            ...
            else:               # https://www.flipkart.com/search?q=iphone
                flipkart_url = "https://www.flipkart.com/search?q=" + searchString # preparing the URL to search the product on flipkart
                uClient = uReq(flipkart_url) # requesting the web-page from the internet
                flipkartPage = uClient.read() # reading the web-page
